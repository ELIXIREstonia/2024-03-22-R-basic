...
You can find this and the data files from ELIXIREstonia github. [`https://github.com/ELIXIREstonia/2023-10-24-R-basic`](https://github.com/ELIXIREstonia/2023-10-24-R-basic).
...
see: [`https://rstudio.github.io/cheatsheets/html/rstudio-ide.html`](https://rstudio.github.io/cheatsheets/html/rstudio-ide.html){.uri} for more detailed overview.
...
You can find this and the data files from ELIXIREstonia github. `https://github.com/ELIXIREstonia/2023-10-24-R-basic`.
...
You're planning a party and need to budget for it. Here's the cost breakdown:
...
Use the arithmetic operations you've learned to answer the following:
...
Now, create variables for each of the costs:
...
2.  **Matrices**: Assume that the ages and scores of students from all three classes (Biology, Chemistry, Physics) are as follows:
...
5.  **Analysis**:
    ...
    -   Using the matrix, calculate the average age and score of students from each class.
